...
module Int128 = struct
  module Base = struct
    ...
    external mul : int128 -> int128 -> int128 = "uint128_mul"
    external div : int128 -> int128 -> int128 = "int128_div"
    external rem : int128 -> int128 -> int128 = "int128_mod"
    external logand : int128 -> int128 -> int128 = "uint128_and"
    external logor : int128 -> int128 -> int128 = "uint128_or"
    external logxor : int128 -> int128 -> int128 = "uint128_xor"
    external shift_left : int128 -> int -> int128 = "uint128_shift_left"
