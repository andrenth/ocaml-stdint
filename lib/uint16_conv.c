...
{
  CAMLparam1(v);
  CAMLreturn (copy_uint16((uint16_t)Int24_val(v)));
}
...
{
  CAMLparam1(v);
  CAMLreturn (copy_uint16((uint16_t)Int40_val(v)));
}
...
{
  CAMLparam1(v);
  CAMLreturn (copy_uint16((uint16_t)Int48_val(v)));
}
...
{
  CAMLparam1(v);
  CAMLreturn (copy_uint16((uint16_t)Int56_val(v)));
}
...
{
  CAMLparam1(v);
  CAMLreturn (copy_uint16((uint16_t)Uint24_val(v)));
}
...
{
  CAMLparam1(v);
  CAMLreturn (copy_uint16((uint16_t)Uint40_val(v)));
}
...
{
  CAMLparam1(v);
  CAMLreturn (copy_uint16((uint16_t)Uint48_val(v)));
}
...
{
  CAMLparam1(v);
  CAMLreturn (copy_uint16((uint16_t)Uint56_val(v)));
}
