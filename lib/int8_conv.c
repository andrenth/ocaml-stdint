...
{
  CAMLparam1(v);
  CAMLreturn (copy_int8((int8_t)Int24_val(v)));
}
...
{
  CAMLparam1(v);
  CAMLreturn (copy_int8((int8_t)Int40_val(v)));
}
...
{
  CAMLparam1(v);
  CAMLreturn (copy_int8((int8_t)Int48_val(v)));
}
...
{
  CAMLparam1(v);
  CAMLreturn (copy_int8((int8_t)Int56_val(v)));
}
...
{
  CAMLparam1(v);
  CAMLreturn (copy_int8((int8_t)Uint40_val(v)));
}
...
{
  CAMLparam1(v);
  CAMLreturn (copy_int8((int8_t)Uint48_val(v)));
}
