...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4c66e29342db7d9632b1e1bface0c7bb) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["uint32_stubs.c"; "uint32.h"];
                      bs_data_files =
                        [("uint32.h", Some "$prefix/include/ocaml_uint")];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "uint"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["uint64_stubs.c"; "uint64.h"];
                      bs_data_files =
                        [("uint64.h", Some "$prefix/include/ocaml_uint")];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\185hU\2309j\176\011\016Q\137~\147\246\253\192";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
