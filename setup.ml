...
(* OASIS_START *)
(* DO NOT EDIT (digest: dcf3aea1eb3036be8a57b0c83a31993d) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_data_files =
                        [
                           ("uint8.h", Some "$prefix/include/ocaml_stdint");
                           ("uint16.h", Some "$prefix/include/ocaml_stdint");
                           ("uint24.h", Some "$prefix/include/ocaml_stdint");
                           ("uint32.h", Some "$prefix/include/ocaml_stdint");
                           ("uint56.h", Some "$prefix/include/ocaml_stdint");
                           ("uint64.h", Some "$prefix/include/ocaml_stdint");
                           ("uint128.h", Some "$prefix/include/ocaml_stdint");
                           ("int8.h", Some "$prefix/include/ocaml_stdint");
                           ("int16.h", Some "$prefix/include/ocaml_stdint");
                           ("int128.h", Some "$prefix/include/ocaml_stdint");
                           ("uint8.h", Some "$libdir/stdint");
                           ("uint16.h", Some "$libdir/stdint");
                           ("uint24.h", Some "$libdir/stdint");
                           ("uint32.h", Some "$libdir/stdint");
                           ("uint56.h", Some "$libdir/stdint");
                           ("uint64.h", Some "$libdir/stdint");
                           ("uint128.h", Some "$libdir/stdint");
                           ("int8.h", Some "$libdir/stdint");
                           ("int16.h", Some "$libdir/stdint");
                           ("int128.h", Some "$libdir/stdint")
                        ];
                   ...
                   },
                   {
                      ...
                      lib_internal_modules =
                        ["Str_conv"; "Bytes_conv"; "Infix"; "Int_wrapper"];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for stdint";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_digest =
       Some "\171\239\134\250\173\007\170\147\206\183`\196\157\183\186Q";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
