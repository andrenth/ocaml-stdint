...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2fc6a3dc1024753f03c4524c71a57b5f) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_data_files =
                        [
                           ("uint8.h", Some "$prefix/include/ocaml_uint");
                           ("uint16.h", Some "$prefix/include/ocaml_uint");
                           ("uint32.h", Some "$prefix/include/ocaml_uint");
                           ("uint64.h", Some "$prefix/include/ocaml_uint");
                           ("int8.h", Some "$prefix/include/ocaml_uint");
                           ("int16.h", Some "$prefix/include/ocaml_uint")
                        ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\023ïB\029(¢àj8D/ç\004Î·U";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
